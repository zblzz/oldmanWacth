...
lv_obj_t *ui_WenZiButton;
lv_obj_t *ui_WenZiLabel;
...
void ui_event_WenZiButton(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    lv_obj_t *target = lv_event_get_target(e);
...
void ui_HomePage_screen_init(void)
{
    ...
    lv_obj_set_height(ui_DropDownPanel, 150);
    ...
    ui_WenZiButton = lv_btn_create(ui_DropDownPanel);
    lv_obj_set_width(ui_WenZiButton, 50);
    lv_obj_set_height(ui_WenZiButton, 50);
    lv_obj_set_x(ui_WenZiButton, 0);
    lv_obj_set_y(ui_WenZiButton, 5);
    lv_obj_add_flag(ui_WenZiButton, LV_OBJ_FLAG_CHECKABLE | LV_OBJ_FLAG_SCROLL_ON_FOCUS); /// Flags
    lv_obj_clear_flag(ui_WenZiButton, LV_OBJ_FLAG_SCROLLABLE);                            /// Flags
    lv_obj_set_style_bg_color(ui_WenZiButton, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_WenZiButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_WenZiButton, lv_color_hex(0x3264C8), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_opa(ui_WenZiButton, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    if (ui_HomePageWenEN)
    {
        lv_obj_add_state(ui_WenZiButton, LV_STATE_CHECKED);
    }

    ui_WenZiLabel = lv_label_create(ui_WenZiButton);
    lv_obj_set_width(ui_WenZiLabel, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_WenZiLabel, LV_SIZE_CONTENT); /// 1
    lv_obj_set_align(ui_WenZiLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_WenZiLabel, "");
    lv_obj_set_style_text_color(ui_WenZiLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_WenZiLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_WenZiLabel, &ui_font_WenZi, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_event_cb(ui_WenZiButton, ui_event_WenZiButton, LV_EVENT_ALL, NULL);
