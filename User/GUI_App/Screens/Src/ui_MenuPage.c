...
// menu list
static const int menu_list[MENU_PAGE_NUM] = {CALENDAR_PAGE_EN, COMPUTER_PAGE_EN, TIMER_PAGE_EN, CARD_PAGE_EN,
                                             SPROTS_PAGE_EN, HR_PAGE_EN, O2_PAGE_EN, ENVIRONMENT_PAGE_EN,
                                             COMPASS_PAGE_EN, GAME_PAGE_EN, SET_PAGE_EN, ABOUT_PAGE_EN};
static int menu_list_index = -1;
 ...
 * @author zbl (zzz)
 */
static uint8_t is_panelEmpty(menu_list_index_e index)
{
    if (menu_list[index] == 0)
        return 1;
    menu_list_index++;
    return 0;
}
...
void ui_MenuPage_screen_init(void)
{
    ...
    // 计算器
    if (!is_panelEmpty(COMPUTER_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuComPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(TIMER_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuTimPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(CARD_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuCardPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(SPROTS_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuSprPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(HR_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuHRPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(O2_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuO2Panel, menu_list_index * 70);
    ...
    // 环境
    if (!is_panelEmpty(ENVIRONMENT_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuEnvPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(COMPASS_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuCPPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(GAME_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuGamePanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(SET_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuSetPanel, menu_list_index * 70);
    ...
    if (!is_panelEmpty(ABOUT_PAGE))
    {
        ...
        lv_obj_set_y(ui_MenuAbPanel, menu_list_index * 70);
        ...
        lv_label_set_text(ui_MenuAbLabel, "Information");
        lv_obj_set_style_text_font(ui_MenuAbLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
